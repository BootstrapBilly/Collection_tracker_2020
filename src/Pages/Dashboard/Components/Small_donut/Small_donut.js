                    ...
                    {[
                        ...
                        .map((circle, index) =>
                            ...
                            <circle id="circle" key={circle[0]}
                                ...
                                style={{ strokeDashoffset: circle[1], strokeDasharray: props.circumference, zIndex: index, position:"relative" }}
                                className={index === 0 ? classes.donut_no_anim : classes.donut}
